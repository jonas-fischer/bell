...
\begin{align*}
P^{2}(t)&=\chi_{2}E^{2}(t)\\
&=\chi_{2}\left[E_{1}^{2}(t)e^{-i2\omega_{1}t}+E_{2}^{2}(t)e^{-i2\omega_{2}t}\\
&+2E_{1}E_{2}e^{-i(\omega_{1}+\omega_{2})t}+2E_{1}E_{2}^{*}e^{-i(\omega_{1}-\omega_{2})t}+c.c.\right]\\
&+2\chi_{2}\left[E_{1}E_{1}^{*}+E_{2}E_{2}^{*}\right]
\end{align*}
