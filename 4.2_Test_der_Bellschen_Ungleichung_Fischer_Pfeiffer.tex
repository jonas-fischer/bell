...
\item Um bei der Umwandlung des Pumpphotons in die beiden Signal und Idler Photonen die Impulserhaltung zu gewährleisten muss der Kristall nichtlineare Phasenangleichung $\left(nonlinear\,phasematching\right)$ erfüllen. Dafür muss der Kristall so präpariert werden, dass die o.B.d.A vertikal Polarisierten Pumpphotonen $\omega_{P}$ 
\end{itemize}
